			...
			<items>
				<c:forEach var="video" items="${videos}">
					<c:if test="${video.isalbum==1}">
						<moviePoster id="shelf_item_${video.itemid}" alwaysShowTitles="true" onSelect="appletv.loadData(${video.itemid},${video.cid},${video.hd});" onPlay="atv.loadURL('${serverurl}/tudou/album.xml?itemid=${video.itemid}&amp;channelId=${video.cid}&amp;hd=${video.hd}');">

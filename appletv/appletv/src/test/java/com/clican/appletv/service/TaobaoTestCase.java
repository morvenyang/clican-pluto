...
//		String content = client.httpGet("http://www.taobao.com",header,null);
//		log.debug(content);
	}
	...
	public void testAddFavorite() throws Exception {
		...
		// nameValueMap.put("style", "default");
		// nameValueMap.put("css_style", "");
		// nameValueMap.put("tid",
		// "XOR_1_000000000000000000000000000000_635833224C0D7C777275037E");
		// PostResponse pr =
		// client.httpPost("https://login.taobao.com/member/login.jhtml", null,
		// nameValueMap, "application/x-www-form-urlencoded", "utf-8",
		// null, null);
		// log.debug(pr.getCookie());
		// log.debug(pr.getContent());
//		taobaoClient.addFavorite(1, 1, null, null, 18180872462L, null);

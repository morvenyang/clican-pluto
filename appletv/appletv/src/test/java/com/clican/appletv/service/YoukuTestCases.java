...
public class YoukuTestCases extends BaseServiceTestCase {
	...
	public void testATVIndex() throws Exception {
		String url = "http://itunes.apple.com/WebObjects/MZStore.woa/wa/storeFront";
		Map<String, String> headers = new HashMap<String, String>();
		//headers.put("X-Apple-Store-Front", "143463-18,18A");
		//headers.put("X-Apple-TV-Resolution", "1080");
		//headers.put("X-Apple-TV-Version", "5.1");
		headers.put("User-Agent", "iTunes-AppleTV/5.1 (3; 8GB; dt:12)");
		String content  = tudouClient.httpGet(url, headers, null);
		System.out.println(content);
	}

	public void testSearch() throws Exception {
		String keyword = URLEncoder.encode("黑猫警长", "UTF-8");
		String url1 = "http://api.3g.youku.com/layout/phone2/ios/search/"
				+ keyword + "?pg=1&pid=69b81504767483cf&pz=30";
		String url2 = "http://api.3g.youku.com/videos/search/" + keyword
				+ "?pg=1&pid=69b81504767483cf&pz=30";
		...
		System.out.println(URLDecoder.decode(
				"%E8%A1%8C%E5%B0%B8%E8%B5%B0%E8%82%89", "UTF-8"));
		System.out.println(URLDecoder.decode(
				"%E5%85%A8%E7%AB%99%E6%90%9C%E7%B4%A2", "UTF-8"));

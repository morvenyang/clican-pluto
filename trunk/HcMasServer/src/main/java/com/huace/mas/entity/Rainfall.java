...
public class Rainfall implements Serializable {
	...
	//配置文件节点对应
	public static String R_rainFall = "rainFall";
	public static String R_deviceID = "deviceID";
	public static String R_pointName= "pointName";
	public static String R_yellow_value= "yellow_value";
	public static String R_orange_value= "orange_value";
	public static String R_red_value= "red_value";
	
	
	//表字段对应
	private int deviceID;//设备ID
	private double v1;//降雨量
	private String dacTime;//时间
	private String projectName;//工程名称
	
	private String pointName;//雨量监测点名称

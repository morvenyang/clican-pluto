...
public class TaobaoTestCase extends BaseServiceTestCase {
	...
	public void testLogin() throws Exception {
		...
		nameValueMap.put("ua", "029YlJgThc3UTYWOBgrdkVwQXNAd0BxRmY5Zg==|YVJ8T35JckN1QnZGdk16SRY=|YFB+JwdGLFwxXjkZNxcnETEfP2oBbQtmE2JCHUI=|Z1Z4IRM9DyESJhQmCDwHNxkqHiweMAs5CyUWIhAiDDYCMG8w|ZlxyUnIt|ZV5wUHAv|ZFdkShMzWS9ZK1piT2IMYQRvAy9ZOlc3VDkVdBl2WzRTPFw7S2YIZQBrBytDKV8wXn5QcFAPUA==|a1hoRmYIZQBrByd4|alliTBUkCjkKOw4gET8ffB8pCVYJ|aVpoRmY/DjsBOwkneVlqW2xWYFNlVmRXYldlGykFMwY0DzoPNQI1ATIDNQI1BVt7VWY5GUY=|aFtqRB09aANvCWQRYEJ3V3lZDEcLKRopBzAeLxwyATAFJXol|b1h2Lw8vAVhjUmVLeEJxLgAyHDwcMgg5Al0C|blt1LAxaCEYbbB16CmYFag1QY0NtXnBLfEYZRg==|bVp0LQ0tA1phUGdJekBzLAIyHDwcMgEzBzdoNw==|bFl3Lg5YCkQZbh94CGQHaA9SYUFvXXNAckZ3KHc=|c0V3RWtZd0dpXXNHdVtuWnRHdENtXm9adEVyQ21WZUt4T3RaaV9xQHVbaFh2R3Av");
		...
		//nameValueMap.put("tid", "XOR_1_000000000000000000000000000000_635833224C0D7C777275037E");
		PostResponse pr = client.httpPost("https://login.taobao.com/member/login.jhtml", null,
				nameValueMap, "application/x-www-form-urlencoded", "utf-8",
				null, null);
		log.debug(pr.getCookie());
	}

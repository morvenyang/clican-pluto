...
function atvuload1(param) {
	var keyword = param['keyword'];
	atv.loadURL('http://10.0.1.5:9000/appletv/tudou/index.xml?keyword='+escape(keyword)+'&channelId=1001');
};

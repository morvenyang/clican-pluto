					...
					<sections>
						<shelfSection>
							<items>
								...
								<actionButton id="album_2" onSelect="atv.loadURL('${serverurl}/ctl/taobao/store.xml?nick=${item.nick}');" onPlay="atv.loadURL('${serverurl}/ctl/taobao/store.xml?nick=${item.nick}');">
									<title>店铺</title>
								</actionButton>

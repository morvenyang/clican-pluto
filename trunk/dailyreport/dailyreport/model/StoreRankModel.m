...
- (void)load:(TTURLRequestCachePolicy)cachePolicy more:(BOOL)more
{
    ...
    NSString* url = [BASE_URL stringByAppendingFormat:@"/storeRank.do?brand=%@&version=%@",[self.brand stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding],VERSION];

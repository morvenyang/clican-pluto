...
- (void) brandDidFinishLoad:(NSMutableArray*) goods date:(NSDate*) date{
    ...
    [self.contentView addSubview:[self createLabel:@"品名" frame:CGRectMake(wOffset, hOffset, SCREEN_WIDTH*133/320, SCREEN_HEIGHT*30/480) textColor:@"#ffffff" font:labelFontSize backgroundColor:STORE_RANK_TABLE_HEAD_COLOR textAlignment:ALIGN_CENTER]];
     wOffset+=SCREEN_WIDTH*133/320+2;
    [self.contentView addSubview:[self createLabel:@"颜色" frame:CGRectMake(wOffset, hOffset, SCREEN_WIDTH*50/320, SCREEN_HEIGHT*30/480) textColor:@"#ffffff" font:labelFontSize backgroundColor:STORE_RANK_TABLE_HEAD_COLOR textAlignment:ALIGN_CENTER]];
    wOffset+=SCREEN_WIDTH*50/320+2;
    ...
    for(int i=0;i<goods.count;i++){
        ...
        label =[self createLabel:rank.name frame:CGRectMake(wOffset, hOffset+i*ROW_HEIGHT, SCREEN_WIDTH*133/320, ROW_CONTENT_HEIGHT) textColor:@"#6a6a6a" font:labelFontSize backgroundColor:@"#f3f3f3" textAlignment:ALIGN_CENTER];
        [self.contentView addSubview:label];
        wOffset+=SCREEN_WIDTH*133/320+2;
        
        label =[self createLabel:rank.colorName frame:CGRectMake(wOffset, hOffset+i*ROW_HEIGHT, SCREEN_WIDTH*50/320, ROW_CONTENT_HEIGHT) textColor:@"#6a6a6a" font:labelFontSize backgroundColor:@"#f3f3f3" textAlignment:ALIGN_CENTER];
        [self.contentView addSubview:label];
        wOffset+=SCREEN_WIDTH*50/320+2;
        label=[self createDecimalLabel:[NSNumber numberWithInt:rank.count.intValue]  frame:CGRectMake(wOffset, hOffset+i*ROW_HEIGHT,SCREEN_WIDTH-wOffset, ROW_CONTENT_HEIGHT) textColor:@"#6a6a6a" font:labelFontSize backgroundColor:@"#f3f3f3" textAlignment:ALIGN_CENTER];
        [self.contentView addSubview:label];
    }

...
#define WEB_CONTENT_SYNC_API @"http://16.158.171.2/appletv/ctl/proxy/sync.zip"
#define WEB_CONTENT_SYNC_VERSION_API @"http://16.158.171.2/appletv/ctl/proxy/sync/version.do"

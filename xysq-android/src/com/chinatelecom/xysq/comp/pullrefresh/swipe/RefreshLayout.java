...
public abstract class RefreshLayout<T extends AbsListView> extends SwipeRefreshLayout implements
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (mAbsListView == null) {
            ...
            // 设置颜色
            this.setColorScheme(R.color.pulltorefresh_lv_header_color1,
                    R.color.pulltorefresh_lv_header_color2, R.color.pulltorefresh_lv_header_color3,
                    R.color.pulltorefresh_lv_header_color4);
        }
    }

...
public class DynamicORMManageHibernateImplTestCase extends BaseTestCase {
	...
	public void testGenerateORM() throws Exception {
		...
		List<PropertyDescription> list = modelDescription
		...
		dynamicClassLoader.loadClass("com.clican.pluto.orm.model.dynamic.Test")
				.newInstance();
	}
}

// $Id: DynamicORMManageHibernateImplTestCase.java 285 2009-05-20 06:47:45Z
// clican $